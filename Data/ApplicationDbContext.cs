    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Flight>().HasData(
                new Flight { FlightId = 1, Airline = "Emirates", DepartureLocation = "Lagos", ArrivalLocation = "Dubai", Amount = "1200", Class = FlightClass.Economy },
                new Flight { FlightId = 2, Airline = "Air France", DepartureLocation = "Lagos", ArrivalLocation = "Paris", Amount = "1100", Class = FlightClass.Business }
            );
            ...
            modelBuilder.Entity<TravelPackage>().HasData(
                new TravelPackage { PackageId = 1, PackageClass = "Luxury", Amount = "2500", Destination = "Dubai", NoOfDays = 5 },
                new TravelPackage { PackageId = 2, PackageClass = "Standard", Amount = "1800", Destination = "Paris", NoOfDays = 3 }
            );
            // modelBuilder.Entity<Flight>().HasData(
            //     new Flight
            //     {
            ...
            //         TravelPackageId = 1   // must match existing TravelPackage.PackageId
            //     },
            //     new Flight
            //     {
            //         FlightId = 2,
            ...
            //         TravelPackageId = 2   // must match existing TravelPackage.PackageId
            //     }
            // );
